    ...
    @endif
        ...
        <table class="table table-striped table-responsive-lg">
            ...
            <tr>
                ...
                <th>No Ujian</th>
                <th>Item Test</th>
                <th>Hasil Gerakan (HGB)</th>
                <th>Nilai Gerakan (NGB)</th>
                <th>Tanggal Test</th>
                <th>Aksi</th>
            </tr>
        </thead>
        <tbody>
            @foreach ($data as $d)
                <tr>
                    ...
                    <td><button class="btn btn-success btn-sm mb-1" wire:click="edit({{$d->id_test2}})" data-toggle="modal" data-target="#edit">Edit</button>
                        <button class="btn btn-danger btn-sm mb-1" data-toggle="modal" data-target="#delete" wire:click="konfirmasiHapus({{$d->id_test2}})">Hapus</button></td>
                </tr>
            @endforeach
        </tbody>
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" wire:model="item">
                                ...
                                <option value="b1">Pull Up (B1)</option>
                                <option value="b2">Sit Up (B2)</option>
                                <option value="b3">Push Up (B3)</option>
                                <option value="b4">Shuttle Up (B4)</option>
                            </select>
                            <div class="text-danger">
                                @error('item')
                                    {{$message}}
                        ...
                        <div class="form-group">
                          <label>Hasil Gerakan (HGB)</label>
                          <input name="hgb" class="form-control" wire:model="hgb">
                          <div class="text-danger">
                              @error('hgb')
                                  {{$message}}
                              @enderror
                      ...
                      <div class="form-group">
                        <label>Nilai Gerakan (NGB)</label>
                        <input name="ngb" class="form-control" wire:model="ngb">
                        <div class="text-danger">
                            @error('ngb')
                                {{$message}}
                            @enderror
